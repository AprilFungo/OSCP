...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2021 at 04:40 AM
...
INSERT INTO `tbl_announcements` (`clm_id`, `clm_title`, `clm_body`, `clm_date`, `clm_author`, `clm_status`) VALUES
(1, 'Pension for October', 'The pension for october will be released on Oct. 15, 2021.', '2021-10-07 13:28:32', 'admin1', 1),
(2, 'AYUDA for seniors', 'Releasing of ayuda for all senior will be:\r\n1. Oct. 20, 2021 8:00am\r\n2. Oct. 21, 2021 8:00am\r\n\r\nKeep Safe everyone!', '2021-10-07 14:25:02', 'admin1', 1);
...
--
ALTER TABLE `tbl_announcements`
  MODIFY `clm_id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_notif`
  MODIFY `clm_id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
