...
if (isset($_POST['loginbtn'])) {
  ...
  if (mysqli_num_rows($q) == 1) {
    ...
    // user
    $q = @mysqli_query($dbc, "SELECT * FROM tbl_seniors WHERE clm_username = '$user' AND clm_password = md5('$pass') AND clm_status = 2");
    if (mysqli_num_rows($q) == 1) {
      $row = mysqli_fetch_array($q);
...
<body class="background-logo">
  <header class="header fixed-top">
    <nav class="navbar navbar-expand-lg navbar-light py-3 py-lg-2">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item ml-lg-2 py-2 py-lg-0"><a class="btn btn-primary" href="#GuestModal" data-toggle="modal">Register</a></li>
          </ul>
        </div>
      </div>
    </nav>
          ...
          <form action="" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="form-group col-lg-6">
                ...
                <input required class="form-control form-control-lg" id="fullName" type="text" name="fullname" placeholder="Your full name">
              </div>
              <div class="form-group col-lg-6">
                <label for="fullName">Citizenship</label>
                <input required class="form-control form-control-lg" id="fullName" type="text" name="citizenship" placeholder="Citizenship">
              </div>
              <div class="form-group col-lg-6">
              ...
              <div class="form-group col-lg-6">
                ...
                <input required class="form-control form-control-lg" id="email" type="number" name="contact" placeholder="Contact Number">
              </div>
              <div class="form-group col-lg-6">
              ...
              <div class="form-group col-lg-6">
                ...
                <input required class="form-control form-control-lg" id="listingUrl" type="text" name="bplace" placeholder="Birth Place">
              </div>
              <div class="form-group col-lg-12">
                <label for="istingTitle">Address</label>
                <input required class="form-control form-control-lg" id="istingTitle" type="text" name="address" placeholder="Address">
              </div>
              <div class="form-group col-lg-6">
              ...
              <div class="form-group col-lg-6">
                ...
                <input required class="form-control form-control-lg" id="listingUrl" type="text" name="religion" placeholder="Religion">
              </div>
    ...
    <div class="container pt-5">
      <div class="row">
        <div class="col-lg-7 mx-auto text-center">
          ...
          ?>
          <p class="h6 text-uppercase text-primary mb-3">ONLINE PORTAL</p>
    ...
    <div class="container py-5">
      <div class="row text-center">
        <div class="col-lg-10 mx-auto">
          <div style="background-color: black;" class="card border-0 shadow">
  ...
  <section class="pb-5">
    <div class="container pb-5">
      <header class="text-center mb-5">
        ...
        <p class="text-muted text-small">What's with in Sta. Magdalena?</p>
      </header>
      <div class="row text-center">
